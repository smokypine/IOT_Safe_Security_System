## 프로젝트 개요
2022년에 Bluetooth를 이용해 원격으로 금고를 제어할 수 있는 프로그램을 아두이노(Arduino)를 통해 구현하였습니다.
...
- 벽면엔 금고의 잠금장치 역할을 할 서보 모터가 들어가는 공간을 구현함.<br/>

<img src = "./figure/제작과정2.png" width="80%"><br/>
- 우측 정면 상단엔 금고의 잠금 여부를 표시하는 2개의 LED 핀을 부착함.
- 
